...
import { getProduct, getRecommend } from '@/core/services/product';
                            ...
                            <div className='mt-1 space-y-2'>
                                <Disclosure as="div" defaultOpen={true} className='mt-2 border rounded-md'>
                                    ...
                                    <Disclosure.Button as={Fragment} >
                                        <button className="p-2 w-full">Availability</button>
                                    </Disclosure.Button>
                                ...
                                <Disclosure as="div" className='mt-2 border rounded-md'>
                                    {/* Render a `Fragment` for the `Disclosure.Button` component */}
                                    <Disclosure.Button as={Fragment} >
                                        <button className="p-2 w-full">Availability</button>
                                    </Disclosure.Button>
