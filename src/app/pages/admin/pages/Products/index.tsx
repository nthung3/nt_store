    ...
    return (
        <div className='mt-18'>
            <div className='container mx-auto'>
                <h1 className='my-5 text-3xl font-semibold'> Product
                </h1>
                <div className=''>
                            ...
                            <thead className="bg-gray-100">
                                <tr>
                                    <th className="px-4 py-2 text-left bg-gray-100">
                                        ...
                                        <input className="w-5 h-5 border-gray-200 rounded" type="checkbox" id="SelectAll" />
                                    </th>
                                    ...
                                    return (
                                        < tr key={item._id} >
                                            <td className="px-4 py-2 bg-white">
                                                ...
                                                <input className="w-5 h-5 border-gray-200 rounded" type="checkbox" id="Row1" />
                                            </td>    <td className="px-4 py-2 text-gray-700 whitespace-nowrap"><img src={item.img} alt="" className='w-10 h-10 rounded' /></td>
                                            ...
                                            <td className="px-4 py-2 text-gray-700 whitespace-nowrap"><Link to={`/admin/editProduct/${item._id}`}>Update</Link></td>
                                        </tr>
                                    )
                                }
                                )}
