...
import { getProductDetail } from '@/lib/features/product/product-slice';
...
export default function DetailContent({ id }: DetailContentProps): JSX.Element {
    ...
    const { result, loading } = productDetail;
                    ...
                    <div className="grid gap-8 lg:grid-cols-4 lg:items-start">
                        ...
                        <div className="lg:sticky lg:top-0">
                            <form className="space-y-4 lg:pt-8">
                                ...
                                <button
                                    type="submit"
                                    className="w-full px-6 py-3 text-sm font-bold tracking-wide text-white uppercase rounded bg-primary"
                                >
                                    Add to cart
                                </button>
                                <button
