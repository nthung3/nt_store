        ...
        <div className="container mx-auto mt-10">
            <div className="py-10 grid grid-cols-1 md:grid-cols-2 justify-between gap-10">
                <div className="text-lg text-gray-300 pr-10 text-left mr-10">
                    <span className="text-textPrimary font-semibold text-xl">Food Craft\ </span>From your neighbor sushi
                    spot to the food you crave, choose from over 300k+ local and national favourites across the U.S
